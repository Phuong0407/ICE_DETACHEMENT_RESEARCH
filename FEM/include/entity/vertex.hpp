...
namespace mesh_entity
{
     ...
     *  It inherits from `mesh_entity<_spdim, 0, index_t>`, where:
     *      - `_spdim` specifies the spatial dimension of the mesh.
    ...
    class vertex : public mesh_entity<_spdim, 0, index_t> {
        public:
            vertex() = default;
            
            explicit vertex(index_t id) : mesh_entity<_spdim, 0, index_t>(id, 0) {}
